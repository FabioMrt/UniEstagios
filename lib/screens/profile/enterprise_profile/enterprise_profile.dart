...
class EnterpriseProfileScreen extends StatefulWidget {
  ...
  @override
  State<EnterpriseProfileScreen> createState() =>
      _EnterpriseProfileScreenState();
}
...
class _EnterpriseProfileScreenState extends State<EnterpriseProfileScreen> {
  ...
  File? _photo;
  String enterpriseProfilePic = '';

  @override
  void initState() {
    super.initState();
    getEnterpriseProfilePic();
  }
  ...
  Future<String> getEnterpriseProfilePic() async {
    var data = await firestore.collection('empresas').doc(user.userId).get();
    enterpriseProfilePic = data['foto'];
    return enterpriseProfilePic;
  }
                  ...
                  child: Stack(
                    ...
                    children: [
                      FutureBuilder<String>(
                          future: getEnterpriseProfilePic(),
